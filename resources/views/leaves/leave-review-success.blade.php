...
<title>PE Portal - Leave Response Submitted</title>
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="content">
            <h2>Leave Response Submitted</h2>
            <div class="success-box">
                <p style="font-weight:600;">Your leave response has been submitted successfully.</p>
