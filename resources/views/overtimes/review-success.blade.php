...
<title>PE Portal - Overtime Response Submitted</title>
...
<style>
    ...
    .success-box { border: 1px solid #bbf7d0; background-color: #ecfdf5; border-radius: 6px; padding: 20px; color: #166534; margin-bottom: 20px; }
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="content">
            <h2>Overtime Response Submitted</h2>
            <div class="success-box">
                <p style="font-weight:600;">Your overtime response has been submitted successfully.</p>
                <p>No further action is required from this link.</p>
            </div>
        </div>
        <div class="footer">
