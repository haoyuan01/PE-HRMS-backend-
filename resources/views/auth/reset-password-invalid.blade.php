...
<title>PE Portal - Link Invalid</title>
...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="error-box">
                <p style="font-weight:600;">This password reset link is not valid.</p>
                <p>The link may have expired or has already been used.</p>
            </div>

            <p class="helper-text">
                Please request a new password reset from the PE Portal login page.<br><br>
                If you continue to experience issues, kindly contact the IT Department for further assistance.
            </p>
        </div>
