...
<title>PE Portal - Passcode Email Sent</title>
...
<style>
    ...
    .status-icon { width: 54px; height: 54px; line-height: 54px; margin: 0 auto 18px auto; border-radius: 50%; background-color: #e6f7fb; color: #17a2b8; font-size: 28px; font-weight: 700; }
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="content">
            ...
            <p>A passcode reset email has been sent to your email address.</p>
        </div>
        <div class="footer">
